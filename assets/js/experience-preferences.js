...
function applyMarketplacePreferences(preferences) {
  ...
  const hideListingLocation = () => { const location = document.getElementById("location"); if (location?.parentElement?.classList.contains("detail-row")) location.parentElement.hidden = true; };
  hideListingLocation();
